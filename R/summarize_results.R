...
#'     office level, not the constituency \code{level} argument used by
#'     \code{\link{scrape_elections}}.}
#'   \item{\code{offices_by_level}}{Named list: distinct office names per office level.}
#' }
#'
#' @examples
#' \donttest{
