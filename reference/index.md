...
- [`downballot_install_python()`](https://gchickering21.github.io/Downballot/reference/downballot_install_python.md)
  : Install Python dependencies for downballotR
- [`downballot_python_status()`](https://gchickering21.github.io/Downballot/reference/downballot_python_status.md)
