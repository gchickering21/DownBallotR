...
- `state`, `election_year`, `election_id`, `candidate_id`
- `office`, `district`, `election_type` (General, Primary, etc.)
- `candidate`, `party`
...
- `state`, `election_year`, `election_id`, `candidate_id`
- `county_or_city`, `candidate`, `votes`
- `county_winner` — `TRUE` for the top vote-getter within each county/city + election

### `level = "precinct"` (CO, MA, ID, SC, NM, VA)

- `state`, `election_id`, `candidate_id`
- `county`, `precinct`, `candidate`, `votes`
- `precinct_winner` — `TRUE` for the top vote-getter within each precinct + election
