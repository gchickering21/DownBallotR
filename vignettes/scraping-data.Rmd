...
| 4 | `state` is North Carolina | NC State Board of Elections scraper (2000–present) |
...
| 7 | `state` is Utah | Utah election results scraper (2023–present) |
| 8 | `state` is Indiana | Indiana voters portal scraper (2019–present) |
| 9 | `state` is Louisiana | Louisiana SOS scraper (1982–present) |
| 10 | All other states | ElectionStats multi-state scraper |
...
#> [1] "colorado"       "idaho"          "massachusetts"  "new_hampshire"
#> [5] "new_mexico"     "new_york"       "south_carolina" "vermont"
#> [9] "virginia"
```
...
- [Utah](utah.html) —
  Utah elections site; statewide + county results, 2023–present
